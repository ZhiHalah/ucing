...
print(socketstring)
botauthtoken2 = 'ca7be9cca6c0ba8734d2d3f717b8f4909d50d89f' #token lu disini
...
def on_message(ws, message):
        ...
        evn = chat['event']
        kesurupan = '{"appversion":"4.1.0","event":"live_message","token":"","useragent":"Web","message":"Hallo para fansku  馃構"}'
        if 1 == 1:
            if z == 0:
                ws.send(kesurupan)
                z = 1
        ...
        ya = '{"appversion":"4.1.0","event":"live_message","token":"","useragent":"Web","message":"OLAIYA ' + random.choice(emot) + '"}'
        ...
        tidur = '{"appversion":"4.1.0","event":"live_message","token":" ","useragent":"Web","message":"Goodbye Deka bobok  dulu 馃槝"}'
        bangun = '{"appversion":"4.1.0","event":"live_message","token":" ","useragent":"Web","message":"Siap komandan laksanakan !!! "}'
